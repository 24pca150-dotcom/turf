...
export const ownerRequest = async (req, res) => {
  const { name, email, phone, upiId, accountNumber = "", ifsc = "", holderName = "" } = req.body;
...
export const registerOwner = async (req, res) => {
  ...
  try {
    ...
    const newOwner = new Owner({
      ...
      upiId: ownerRequest ? ownerRequest.upiId : "",
      qrCode: ownerRequest ? ownerRequest.qrCode : "",
      bankDetails: ownerRequest ? ownerRequest.bankDetails : {},
    });
    await newOwner.save();
